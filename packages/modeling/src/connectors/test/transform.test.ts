...
test("connector: transform() should return a connector with correct values", (t) => {
	...
	t.true(
		compareVectors(obs1.normal, [0.5773502691896258, -0.5773502691896258, 0.5773502691896258])
	);
	...
	t.true(
		compareVectors(obs2.normal, [0.5773502691896256, -0.5773502691896256, 0.5773502691896261])
	);
	...
	t.true(
		compareVectors(obs3.normal, [0.1690308509457033, -0.5070925528371097, 0.8451542547285166])
	);
