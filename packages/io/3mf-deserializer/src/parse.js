...
const parseTriangle = (attributes) => {
	...
	obj.indices = [parseFloat(attributes.v1), parseFloat(attributes.v2), parseFloat(attributes.v3)];
	if (attributes.p1) {
		obj.p1 = parseFloat(attributes.p1);
	}
	if (attributes.p2) {
		obj.p2 = parseFloat(attributes.p2);
	}
	if (attributes.p3) {
		obj.p3 = parseFloat(attributes.p3);
	}
	if (attributes.pid) {
		obj.pid = attributes.pid;
	}
...
const parseItem = (attributes) => {
	...
	if (attributes.transform) {
		obj.transform = convertTransform(attributes.transform);
	}
...
const parseObject = (attributes) => {
	...
	if (attributes.type) {
		obj.otype = attributes.type;
	}

	if (attributes.partnumber) {
		obj.partnumber = attributes.partnumber;
	}
	if (attributes.name) {
	...
	if (attributes.pindex) {
		obj.pindex = parseFloat(attributes.pindex);
	}
