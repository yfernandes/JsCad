...
test("offset: offset option validation", (t) => {
	...
	t.throws(() => offset({corners: "round", segments: null}, empty), {
		message: "segments must be a finite number",
	});
	t.throws(() => offset({corners: "round", segments: undefined}, empty), {
		message: "segments must be a finite number",
	});
	t.throws(() => offset({corners: "round", segments: Infinity}, empty), {
		message: "segments must be a finite number",
	});
	t.throws(() => offset({corners: "round", segments: NaN}, empty), {
		message: "segments must be a finite number",
	});
	t.throws(() => offset({corners: "round", segments: 0}, empty), {
		message: "segments must be greater than zero",
	});
	t.throws(() => offset({corners: "round", segments: -1}, empty), {
		message: "segments must be greater than zero",
	});
	t.throws(() => offset({corners: null}, empty), {
		message: 'corners must be "edge", "chamfer", or "round"',
	});
	t.throws(() => offset({corners: undefined}, empty), {
		message: 'corners must be "edge", "chamfer", or "round"',
	});
	t.throws(() => offset({corners: 4}, empty), {
		message: 'corners must be "edge", "chamfer", or "round"',
	});
	t.throws(() => offset({corners: "fluffy"}, empty), {
		message: 'corners must be "edge", "chamfer", or "round"',
	});
});
