...
} from "../parameters/getParameterDefinitionsFromSource.js";
			...
			if (extensions[baseExt]) {
				...
				const matchingModule = {
					...
					_compile: (content, fileName) => {
						...
						const paramDefFromSource = content.includes("@jscad-params")
							? getParameterDefinitionsFromSource(content, fileName)
							: [];
