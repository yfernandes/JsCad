...
export function update(
	{
		...
		camera:
			| typeof import("../cameras/orthographicCamera").cameraState
			| typeof import("../cameras/perspectiveCamera").cameraState;
	},
	output?: any
): {
	controls: {
...
export function zoomToFit({
	...
	entities: {
		geometry: Geometry;
		visuals: {drawCmd: string; show: boolean; transparent: boolean; useVertexColors: boolean};
	}[];
}): {
	controls: typeof controlsState;
	camera:
