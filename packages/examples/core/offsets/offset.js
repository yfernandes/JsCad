...
const main = () => {
	...
	const geom2Example = colorize(colorNameToRgb("black"), rectangle({size: [16, 16]}));
	...
	// and 3d geometry
	const geom3Example = colorize(colorNameToRgb("green"), cuboid({size: [2, 7, 4]}));
	...
	return [
		...
		translate(
			[30, 10, 0],
			[geom2Example, expandedGeom2Edge, expandedGeom2Chamfer, expandedGeom2Round, contractedGeom2]
		),

		translate([50, 10, 0], [geom3Example, expandedGeom3]),
	];
};
