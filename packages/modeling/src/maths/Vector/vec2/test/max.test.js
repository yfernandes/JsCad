...
import {max, fromValues} from "./index.js";

import {compareVectors} from "../../../test/helpers/index.js";

test("vec2: max() called with three parameters should update a vec2 with correct values", (t) => {
