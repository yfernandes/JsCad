...
test("deserialize issue 885", (t) => {
	...
	t.throws(
		...
		{instanceOf: Error},
		"Malformed svg path at 2:445. Path closed itself with command #29: \"Q2.12 -3.54 1.84 -3.17\". to avoid this error use pathSelfClosed:'split' or pathSelfClosed:'trim' option"
	);
