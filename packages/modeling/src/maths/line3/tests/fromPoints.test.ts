...
test("line3: fromPoints() should return a new line3 with correct values", (t) => {
	...
	obs = Line3.fromPoints(obs, [0, 5, 0], [0, 5, 0]);
	pnt = obs[0];
	dir = obs[1];
