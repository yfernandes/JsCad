...
test("blobs of array buffers", (t) => {
	...
	// multiple buffers
	ablob = new Blob([Int32Array.from("12345").buffer, Int16Array.from("67890").buffer], {
		length: 5000,
	});
	t.is(ablob.size, 30);
	t.is(ablob.type, "");
...
test("blob methods", (t) => {
	const ablob = new Blob([Int32Array.from("12345").buffer, Int16Array.from("67890").buffer], {
		length: 5000,
	});
	t.is(ablob.size, 30);
