import {IVec2, IVec3, Vector} from "../Vector/Vector.js";
...
export class Vec3 extends Vector {
	 ...
	 */
	public static cloneVec3(vector: IVec3): IVec3 {
		return super.clone(vector, super.create(3));
	}
	 ...
	 */
	public static createVec3(): IVec3 {
		return super.create(3);
	}
