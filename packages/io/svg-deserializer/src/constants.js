...
export const inchMM = 1 / (1 / 0.03937); // used for scaling SVG coordinates(IN) to CAG coordinates(MM)
export const ptMM = 1 / (1 / 0.03937 / 72); // used for scaling SVG coordinates(IN) to CAG coordinates(MM)
export const pcMM = 1 / ((1 / 0.03937 / 72) * 12); // used for scaling SVG coordinates(PC) to CAG coordinates(MM)
